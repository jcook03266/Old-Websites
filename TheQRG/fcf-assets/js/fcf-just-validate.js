// Credit for this goes to: https://github.com/horprogs/Just-validate 
// Forked on April 2020, and very slightly modified 
'use strict';
        ...
        renderErrors: function renderErrors() {
            ...
            for (var _item in this.result) {
                ...
                if ($elem.type === 'checkbox' || $elem.type === 'radio') {
                    ...
                    $elem.parentNode.insertAdjacentElement('afterend',div);
                }
            }
